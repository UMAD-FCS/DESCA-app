...
*======================================================================================*
* Personas en hogares con agua potable
*======================================================================================*
	...
	xml_tab MATR, save("$tabulados\Agua potable.xls") replace
...
local i=1
	...
	qui: mean NBI_agua11 [aw=bc_peso] if bc_dpto==`dpto'
	matrix MATR  [`i',4]=  e(b)
	local i=`i'+1

	}
    *
xml_tab MATR, save("$tabulados\Agua potable.xls") sh("D`dpto'") append
