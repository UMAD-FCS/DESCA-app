...
**
xml_tab MATR, save("$tabulados\SS_activos_ocupadosnoaporta.xls") sh("T") replace
**
...
xml_tab MATR, save("$tabulados\SS_activos_ocupadosnoaporta.xls") sh("Q`quintil'") append
	}
    *
...
xml_tab MATR, save("$tabulados\SS_activos_ocupadosnoaporta.xls") sh("S`sexo'") append
	}
    *
...
local i=1
    ...
    *
xml_tab MATR, save("$tabulados\SS_activos_ocupadosnoaporta.xls") sh("D`dpto'") append
...
xml_tab MATR, save("$tabulados\SS_activos_ocupadosnoaporta.xls") sh("A`asc'") append
	}
    *
