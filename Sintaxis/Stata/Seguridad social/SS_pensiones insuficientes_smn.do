...
local i=1
	...
	g pensiones_def = pensiones / coef

	
	g pensiones_insuf = 0
	replace pensiones_insuf=1 if pensiones_def<15000 /*valor smn enero 2019*/
...
**
xml_tab MATR, save("$tabulados\SS_pensiones insfu_smn.xls") sh("T") replace
**
...
xml_tab MATR, save("$tabulados\SS_pensiones insfu_smn.xls") sh("Q`quintil'") append
	}
    *
...
xml_tab MATR, save("$tabulados\SS_pensiones insfu_smn.xls") sh("S`sexo'") append
	}
    *
...
xml_tab MATR, save("$tabulados\SS_pensiones insfu_smn.xls") sh("A`asc'") append
	}
    *
