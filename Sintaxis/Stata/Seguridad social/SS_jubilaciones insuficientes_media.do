...
*======================================================================================*
	...
	replace jubilaciones_insuf=1 if jubilaciones<(r(mean)/2)
...
**
xml_tab MATR, save("$tabulados\SS_jubilaciones insfu_media.xls") sh("T") replace
**
...
xml_tab MATR, save("$tabulados\SS_jubilaciones insfu_media.xls") sh("Q`quintil'") append
	}
    *
...
xml_tab MATR, save("$tabulados\SS_jubilaciones insfu_media.xls") sh("S`sexo'") append
	}
    *
...
xml_tab MATR, save("$tabulados\SS_jubilaciones insfu_media.xls") sh("A`asc'") append
	}
    *
