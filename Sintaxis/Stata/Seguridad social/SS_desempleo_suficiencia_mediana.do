...
*======================================================================================*
* % de desempleados (de 1 a 6 meses)  que cobran seguro de desempleo por debajo de la mitad de la mediana de los ingresos laborales nacionales
*======================================================================================*
...
local i=1
	...
	g desempinsuf = 0
	replace desempinsuf=1 if g148_3<(r(p50)/2)
...
**
xml_tab MATR, save("$tabulados\SS_desemp_insuf_mediana.xls") sh("T") replace
**
