...
*======================================================================================*
	...
	sum jubilaciones [fw=bc_peso] if jubilaciones>0, detail
	
	g jubilaciones_insuf = 0
	replace jubilaciones_insuf=1 if jubilaciones<lp06_individual
...
**
xml_tab MATR, save("$tabulados\SS_jubilaciones insfu_lp.xls") sh("T") replace
**
...
xml_tab MATR, save("$tabulados\SS_jubilaciones insfu_lp.xls") sh("Q`quintil'") append
	}
    *
...
xml_tab MATR, save("$tabulados\SS_jubilaciones insfu_lp.xls") sh("S`sexo'") append
	}
    *
...
xml_tab MATR, save("$tabulados\SS_jubilaciones insfu_lp.xls") sh("A`asc'") append
	}
    *
