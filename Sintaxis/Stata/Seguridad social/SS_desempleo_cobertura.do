...
local i=1
	...
	g seguroparo=0
	replace seguroparo=1 if bc_pobp == 5
	
	qui: mean seguroparo [aw=bc_peso] if bc_pobp==4 | bc_pobp==5
	matrix MATR  [`i',4]=  e(b)
	local i=`i'+1
...
**
xml_tab MATR, save("$tabulados\SS_desemp_cobertura.xls") sh("T") replace
**
