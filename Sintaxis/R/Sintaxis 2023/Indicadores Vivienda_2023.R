...
v_2023 <- rbind(v_01, v_02, v_03, v_04, v_05, v_06, v_07, v_08, v_09, v_10, v_11, v_12)

v_2023 <- as.data.frame(v_2023)


v_2023 <- v_2023 %>% mutate(filter = ifelse((CORTE == "Departamento" & 
                                              (CODIND == "230201" | 
                                                 CODIND == "230202" | 
                                                 CODIND == "230203" | 
                                                 CODIND == "230302" | 
...
table(v_2023$filter)
v_2023 <- filter(v_2023, filter == 0)

v_2023$filter <- NULL


rio::export(v_2023, "Tabulados 2023/v_2023.xlsx" )
