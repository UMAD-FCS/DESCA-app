...
base          <- rio::import("data_ech/ECH_2023.csv")
...
amb_2023 <- rbind(a_01, a_02, a_03)

amb_2023 <- as.data.frame(amb_2023)

rio::export(amb_2023, "Tabulados/Tabulados 2023/amb_2023.xlsx" )
