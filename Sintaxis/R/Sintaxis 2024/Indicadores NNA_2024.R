...
base <- base %>% dplyr::mutate(tus = ifelse(e584==1, 1, 0))
...
nna_2024 <- rbind(nna_01, nna_02, nna_03, nna_04, nna_05, nna_06, nna_07, nna_08)

rio::export(nna_2024, "Tabulados/Tabulados 2024/nna_2024.xlsx")
