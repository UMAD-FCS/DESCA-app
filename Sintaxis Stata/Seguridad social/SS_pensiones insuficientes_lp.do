...
local i=1
	...
	g pensiones_insuf = 0
	replace pensiones_insuf=1 if pensiones<lp06_individual
...
**
xml_tab MATR, save("$tabulados\SS_pensiones insfu_lp.xls") sh("T") replace
**
...
xml_tab MATR, save("$tabulados\SS_pensiones insfu_lp.xls") sh("Q`quintil'") append
	}
    *
...
xml_tab MATR, save("$tabulados\SS_pensiones insfu_lp.xls") sh("S`sexo'") append
	}
    *
...
xml_tab MATR, save("$tabulados\SS_pensiones insfu_lp.xls") sh("A`asc'") append
	}
    *
