...
*======================================================================================*
* % de desempleados (de 1 a 6 meses)  que cobran seguro de desempleo por debajo de la línea de pobreza
*======================================================================================*
...
local i=1
	...
	g desempinsuf = 0
	replace desempinsuf = 1 if g148_3 < lp06_individual
...
**
xml_tab MATR, save("$tabulados\SS_desemp_insuf_lp.xls") sh("T") replace
**
