...
*======================================================================================*
* Porcentaje de personas residiendo en viviendas con paredes de desecho o techos de desecho o piso de tierra
*======================================================================================*
	...
	xml_tab MATR, save("$tabulados\Paredes desecho.xls") replace
...
local i=1
	...
	qui: mean NBI_materialidad11 [aw=bc_peso] if bc_dpto==`dpto'
	matrix MATR  [`i',4]=  e(b)
	local i=`i'+1

	}
    *
xml_tab MATR, save("$tabulados\Paredes desecho.xls") sh("D`dpto'") append
