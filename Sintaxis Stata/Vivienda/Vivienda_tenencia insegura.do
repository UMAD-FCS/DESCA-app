...
local i=1
	...
	qui: mean bd_tenenciainsegura [aw=bc_peso]
	matrix MATR  [`i',4]=  e(b)
	local i=`i'+1
...
**
xml_tab MATR, save("$tabulados\Tenencia insegura.xls") sh("T") replace
**
...
local i=1
	...
	qui: mean bd_tenenciainsegura [aw=bc_peso] if bd_quintilesy==`quintil'
	matrix MATR  [`i',4]=  e(b)
	local i=`i'+1

	}
xml_tab MATR, save("$tabulados\Tenencia insegura.xls") sh("Q`quintil'") append
	}
    *
...
local i=1
	...
	qui: mean bd_tenenciainsegura [aw=bc_peso] if bc_pe2==`sexo'
	matrix MATR  [`i',4]=  e(b)
	local i=`i'+1

	}
xml_tab MATR, save("$tabulados\Tenencia insegura.xls") sh("S`sexo'") append
	}
    *
...
local i=1
	...
	qui: mean bd_tenenciainsegura [aw=bc_peso] if tramo==`edad'
	matrix MATR  [`i',4]=  e(b)
	local i=`i'+1

	}
xml_tab MATR, save("$tabulados\Tenencia insegura.xls") sh("E`edad'") append
	}
    *
...
local i=1
	...
	qui: mean bd_tenenciainsegura [aw=bc_peso] if bc_dpto==`dpto'
	matrix MATR  [`i',4]=  e(b)
	local i=`i'+1

	}
    *
xml_tab MATR, save("$tabulados\Tenencia insegura.xls") sh("D`dpto'") append
...
local i=1
	...
	qui: mean bd_tenenciainsegura [aw=bc_peso] if bd_e29_1==`asc'
	matrix MATR  [`i',4]=  e(b)
	local i=`i'+1

	}
xml_tab MATR, save("$tabulados\Tenencia insegura.xls") sh("A`asc'") append
	}
    *
