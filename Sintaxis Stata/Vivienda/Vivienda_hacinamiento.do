...
*======================================================================================*
	...
	xml_tab MATR, save("$tabulados\Hacinamiento.xls") replace
...
local i=1
	...
	qui: mean bd_hacinamiento [aw=bc_peso] if bc_dpto==`dpto'
	matrix MATR  [`i',4]=  e(b)
	local i=`i'+1

	}
    *
xml_tab MATR, save("$tabulados\Hacinamiento.xls") sh("D`dpto'") append
